...
?>
<div class="woo-tour-info col-md-12 <?php if(get_option('wt_metaposition') == 'above'){ echo 'meta-full-style';}?>">
	<?php 
            ...
            <div class="<?php echo $class;?>">
                <div class="media">
                    <div class="media-body">
                        ...
                        <div class="media-heading anchorlocation">
                            <?php echo $location;?>
                        </div>
                    </div>
                </div>
	...
	if(is_array($wt_custom_metadata) && !empty($wt_custom_metadata)){
		...
		<div class="wt-custom-info col-md-4 col-sm-4">
			<?php 
			$i = 0;
