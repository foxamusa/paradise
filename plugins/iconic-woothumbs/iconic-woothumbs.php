<?php
/*
Plugin Name: WooThumbs - Awesome Product Imagery | Shared By Themes24x7.com
...
class Iconic_WooThumbs {
    ...
    private function define_constants() {
        ...
        $this->define( 'ICONIC_WOOTHUMBS_IS_ENVATO', true );
    ...
    public function load_settings_framework() {
        ...
        // Validate Settings
        add_filter( 'iconic_woothumbs_settings_validate', array( $this, 'validate_settings' ), 10, 1 );
    ...
    public function maybe_enable_fullscreen() {
        ...
        return ( $this->settings['fullscreen_general_enable'] || $jckqv );
    }
    ...
    public function get_all_image_sizes( $variation_id ) {
        ...
        return apply_filters( 'iconic_woothumbs_all_images_data', $images, $variation_id );
